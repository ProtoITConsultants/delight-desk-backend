...
- **[Requires Approval filter (frontend handoff)](frontend/approval-queue-requires-approval-filter.md)** — Filter approval queue items that have actions awaiting human approval.
